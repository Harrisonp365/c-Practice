...
void ImageDialog::addTagClicked()
{
    ...
    if(ok)
    {
        ...
        {
            QMessageBox::warning(this, tr("Image Book"), tr("This is not a valid tag." "Tags consit of lower case characters a-z"));
            return;
        }
...
void ImageDialog::updateCurrentImage()
{
    ...
    {
        ui->imagesLabel->setPixmap(
                    QPixmap::fromImage(
                        images->getImage(imageIds[currentImage])));
        ui->imagesLabel->clear();
